...
import ud5.mulleres.MulleresTraballadoras.MullerTraballadora;
...
public class ProgPrincipal {
    public static void main(String[] args) {
        ...
        /*
        System.out.println(MullerTraballadora);
        System.out.println( + " foi pioneira en: " + IPionera);
        System.out.println(MullerTraballadora + " defendeu a causa: " + IActivista);
        */
